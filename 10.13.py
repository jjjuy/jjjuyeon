class Rectangle:
    ...
    def overlaps(self,r):
        if (self._x + self._width < r._x or r._x + r._width < self._x or self._y +self._height < r._y or r._y + r._height < self._y):
            return False
        return True

    def contains(self, r):
        return (self._x <= r._x and self._y <= r._y and self._x + self._width >= r._x + r._width and self._y + self._height >= r._y + r._height)
